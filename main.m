...
xlabel(c,'$\int S^\downarrow \,  dt$ [MJ]','Interpreter','Latex','FontSize',18);
...
c.FontSize=10;
caxis([min(img(:)) max(img(:))]);
xlabel(c,'$\int L^\downarrow \,  dt$ [MJ]','Interpreter','Latex','FontSize',18);
...
title(sprintf('TopoSUB+TopoSCALEd ERA5 data for %s in 2019',sites),...
